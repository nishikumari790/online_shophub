...
const products = [
  ...
  { id:16, 
   ...
   category:"Home Appliances",  price:89,   
   rating:4.7, 
   reviews:9812,  
  ...
  { id:20, name:"Atomic Habits — James Clear",      
   category:"Books",            
   price:14,   
   rating:4.9, 
   reviews:48231, 
  ...
  { id:23, name:"Deep Work — Cal Newport",          
   category:"Books",            
   price:15,   
   rating:4.6, 
   reviews:18900, 
  ...
  { id:24, name:"The Design of Everyday Things",   
   category:"Books",            
   price:18,   
   rating:4.5, 
   reviews:8340,  
